      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-white bg-clip-text text-transparent">
              assistAI
            </h3>
            <p className="text-gray-300 mb-4">
              Transforming businesses through intelligent automation and AI solutions. 
              Let us help you unlock your organization's full potential.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <button 
              ...
              className="text-gray-500 hover:text-gray-400 text-xs mt-2 md:mt-0"
            >
              Admin
            </button>
          </div>
          ...
          {showAdminLogin && (
            <div className="mt-6 max-w-md mx-auto bg-gray-800 p-6 rounded-lg">
              <h4 className="text-lg font-semibold mb-4">Admin Login</h4>
