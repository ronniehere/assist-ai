...
const Hero = () => {
  ...
  return (
    <section className="pt-32 pb-16 bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <Button 
            ...
            size="lg"
            className="bg-gradient-to-r from-blue-600 to-gray-900 hover:from-blue-700 hover:to-black text-white px-8 py-4 text-lg rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            GET STARTED
          </Button>
        </div>
